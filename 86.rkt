...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |86|) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp")) #f)))
...
(define (edit ed ke)
  (cond
    ...
    [(>= (image-width (text (string-append (editor-pre ed) (editor-post ed)) FONTSIZE FONTCOLOR)) WIDTH) ed]
